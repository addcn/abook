...
import com.dodo.android.abook.widget.simplelinechart.circlepercentchart.CirclePercentChart;
...
public class PercentActivity extends AppCompatActivity {
    ...
    private void initView() {
        mCirclePercentChart = (CirclePercentChart) findViewById(R.id.circle_percent_chart);
    }
