 ...
 *
 * Created by dodo on 2016/8/31.
 */

public class IQiYiLoading extends View {
    ...
    public IQiYiLoading(Context context) {
        super(context);
        init();
        initAnimation();
        animator.start();
    ...
    public IQiYiLoading(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
        initAnimation();
    ...
    public IQiYiLoading(Context context, AttributeSet attrs, int defStyleAttr) {
