 ...
 *
 * https://madreain.github.io/2017/07/28/20170728/
 */
public class MadreainLoadingView extends View {
    ...
    public MadreainLoadingView(Context context) {
        super(context);
        initPaint();
        initHandler();
        initListener();
    }
    public MadreainLoadingView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        backgroudColor=Color.parseColor("#66000000");
        mpaintColor = Color.BLUE;
        mpaintStrokeWidth = 16;
        textPaintColor = Color.BLUE;
        textPaintStrokeWidth = 6;
        textPaintTextSize = 60;
        radius = 100;
        circleRadius = 16;
        roundCount = 10;
        int type = 0;
    ...
    public MadreainLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        });
        successvalueAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                //动画结束，隐藏状态
                MadreainLoadingView.this.setVisibility(GONE);
            }
            @Override
            public void onAnimationCancel(Animator animator) {
            }
