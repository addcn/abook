package com.dodo.android.abook.widget.simplelinechart.circlepercentchart;
...
import com.dodo.android.abook.widget.simplelinechart.circlepercentchart.exception.PercentOverFlowException;
import com.dodo.android.abook.widget.simplelinechart.circlepercentchart.vo.ArcVo;
import com.dodo.android.abook.widget.simplelinechart.utils.UiUtils;
...
public class CirclePercentChart extends View {
    ...
    private void initRect() {
        post(new Runnable() {
            @Override
            public void run() {
                mDrawCircleRect = new RectF(0, 0, getMeasuredWidth(), getMeasuredHeight());
                mRaduis = getMeasuredHeight() / 2;
            }
        });
