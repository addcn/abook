...
import com.dodo.android.abook.widget.simplelinechart.chartline.ChartLine;
import com.dodo.android.abook.widget.simplelinechart.chartline.exception.YCoordinateException;
import com.dodo.android.abook.widget.simplelinechart.chartline.vo.DotVo;
 ...
 * https://segmentfault.com/a/1190000011276939
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonPercentChart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ChartLineActivity.this, PercentActivity.class));
            }
        });
